                        ...
                        <div className="case">
                            <div className="row">
                                <div className="col-md-6 col-lg-6 col-xl-8 d-flex">
                                    <a href="blog-single.html" className="img w-100 mb-3 mb-md-0" style={{ backgroundImage: `url(https://images.pexels.com/photos/34153/pexels-photo.jpg?auto=compress&cs=tinysrgb&h=350)` }}></a>
                                </div>
